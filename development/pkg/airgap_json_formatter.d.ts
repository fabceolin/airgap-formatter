 ...
 */
export function createSharePayload(json: string, passphrase: string): string;

/**
 * Decode a shared payload, returning JSON with result or error.
 */
export function decodeSharePayload(data: string, key_or_passphrase: string, is_passphrase: boolean): string;
...
export interface InitOutput {
    ...
    readonly createSharePayload: (a: number, b: number, c: number, d: number) => [number, number];
    readonly decodeSharePayload: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    ...
    readonly highlightMarkdown: (a: number, b: number) => [number, number];
    ...
    readonly renderMarkdown: (a: number, b: number) => [number, number];
