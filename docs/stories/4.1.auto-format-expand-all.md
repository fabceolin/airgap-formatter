...
- [x] Task 1: Implement auto-format on paste (AC: 1, 2, 3, 4, 5)
...
- [x] Task 2: Implement expand all on first render (AC: 6, 7, 9)
...
- [x] Task 3: Add performance guard for large JSON (AC: 8)
